...
1. Go to <a href="https://learn.microsoft.com/en-us/training/modules/csharp-readable-code/" target="_blank">https://learn.microsoft.com/en-us/training/modules/csharp-readable-code/</a> and complete all the tasks for the "Create Readable Code with Conventions, Whitespace, and Comments in C#" module. Це обов’язково, щоб отримати трофей «Створення та запуск простих консольних застосунків C#».
